...
void result() {
    if (win == 'X')
        cout << PlayerName1 << "вы  выиграли поздравл€ем " << PlayerName2 << " а вы проиграли..." << endl;
    else if (win == 'O') cout << PlayerName2 << "вы  выиграли поздравл€ем  " << PlayerName1 << " а вы проиграли..." << endl;
...
int main(int argc, char** argv) {
    ...
    do {
        cout << "¬ведите им€ первого игрока : ";
        gets_s(PlayerName1);

        cout << "¬ведите им€ второго игрока: ";
        gets_s(PlayerName2);
        cout << "\n";
